...
sealed interface DetailsOp {
  data object Create : DetailsOp
  data class Update(val id: String) : DetailsOp
}
...
class DetailsCompositor(
  ...
  private val item = when(op) {
    DetailsOp.Create -> null
    is DetailsOp.Update -> TodoRepo.findItem(op.id)
  }
